            ...
            <main className="container mx-auto px-6 py-16">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-16">
                        {/* Left Column */}
                        <div>
                            <h2 className="text-2xl font-bold text-white mb-6">Cosa si farà?</h2>
                            <ul className="space-y-3 text-zinc-300 text-lg">
                                <li className="flex items-start gap-3">
                                    <span className="text-fuh-primary mt-1">•</span>
                                    <span>Metodi di Decarbossilazione</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-fuh-primary mt-1">•</span>
                                    <span>Metodi di Chiarificazione ed estrazione</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-fuh-primary mt-1">•</span>
                                    <span>Metodi di infusione</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-zinc-300 text-lg">
                                <p>
                                    <span className="font-semibold text-white">Data:</span> Lunedì 10 Marzo 2025, dalle 9:30 alle 13:30
                                </p>
                                <p>
                                    <span className="font-semibold text-white">Location:</span> In Villa oppure Online su Zoom
                                </p>
                            </div>
                        </div>
                    </div>
